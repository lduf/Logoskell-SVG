...
newCrayon (Crayon (Coordonnee x y) (Angle a)) dist 0 = Crayon (Coordonnee (x + dist*(cos a)) (y + dist*(sin a))) Angle a --  pour un x vérifier les modulations de pi
newCrayon (Crayon coo (Angle a)) 0 angle = Crayon coo (Angle (a+angle)) -- Pour un left ou right

-- Generation d'une ligne SVG avec des coordonnées

svgLine :: Crayon -> Crayon ->String
svgLine (coo1 _) (coo2 _) = svgLinecoo coo1 coo2 
